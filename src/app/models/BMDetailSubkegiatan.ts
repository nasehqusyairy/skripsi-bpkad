...
export class BMDetailSubkegiatan extends Model<IBMDetailSubkegiatan> implements IBMDetailSubkegiatan {
    constructor(attributes: Partial<IBMDetailSubkegiatan> = {}) {
        super(attributes);
    }
